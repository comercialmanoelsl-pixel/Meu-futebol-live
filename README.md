...
# V52 - Correção tela travada na aba Escalações

Correção feita:
- `renderMainPanel()` estava chamando `renderLineups()` mas não colocava o retorno dentro do `mainPanel`.
- Agora usa: `$("mainPanel").innerHTML = renderLineups();`

Esse era o motivo dos blocos cinza/skeleton ficarem na tela quando clicava em Escalações.
