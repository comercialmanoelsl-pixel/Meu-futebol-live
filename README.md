...
## V18.4 — SportMonks Strict Stats
- Finalizações agora usam APENAS type_id 42 / SHOTS_TOTAL da SportMonks.
- Não usa mais goal-attempts como finalização.
- Não soma shots on target + off target + blocked como fallback para total.
- Chutes no gol seguem type_id 86.
- Escanteios seguem type_id 34.
- Posse segue type_id 45.
